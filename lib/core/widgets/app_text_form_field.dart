...
class AppTextFormField extends StatelessWidget {
  ...
  const AppTextFormField({super.key, this.contentPadding, this.focusedBorder, this.enabledBorder, this.inputTextStyle, this.hintStyle, required this.hintText, this.suffixIcon, this.isObscureText,  this.backgroundColor,  this.controller, required this.validator});
